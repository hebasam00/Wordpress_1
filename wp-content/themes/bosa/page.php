...
<div id="content" class="site-content">
	<div class="container">
		<section class="wrap-detail-page">
			<?php if( get_theme_mod( 'disable_transparent_header_page', true ) || ( get_theme_mod( 'header_layout', 'header_one' ) != 'header_two'  && get_theme_mod( 'header_layout', 'header_one' ) != 'header_ten' ) ){ 
