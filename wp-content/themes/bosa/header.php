...
<div id="page" class="site">
	...
	}elseif( get_theme_mod( 'header_layout', 'header_one' ) == 'header_six' ) {
		get_template_part( 'template-parts/header/header', 'six' );
	}elseif( get_theme_mod( 'header_layout', 'header_one' ) == 'header_seven' ) {
		get_template_part( 'template-parts/header/header', 'seven' );
	}elseif( get_theme_mod( 'header_layout', 'header_one' ) == 'header_ten' ) {
		get_template_part( 'template-parts/header/header', 'ten' );
	}elseif( get_theme_mod( 'header_layout', 'header_one' ) == 'header_eleven' ) {
		get_template_part( 'template-parts/header/header', 'eleven' );
	}elseif( get_theme_mod( 'header_layout', 'header_one' ) == 'header_twelve' ) {
		get_template_part( 'template-parts/header/header', 'twelve' );
	}elseif( get_theme_mod( 'header_layout', 'header_one' ) == 'header_thirteen' ) {
		get_template_part( 'template-parts/header/header', 'thirteen' );
	}elseif( get_theme_mod( 'header_layout', 'header_one' ) == 'header_fourteen' ) {
